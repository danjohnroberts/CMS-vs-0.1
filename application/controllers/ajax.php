    ...
    public function apply_jquery()
    {
        if ($_POST) {
            ...
            foreach ($_POST AS $field => $value) {
                ...
                if ($field == "Telephone") {
                    $Body .= "<hr/><h3>Contact details</h3>";
                } //$field == "Telephone"
                
                if ($field == "Address") {
                    $Body .= "<hr/><h3>Address details</h3>";
                } //$field == "Address"
                
                if ($field == "Title") {
                    $Body .= "<p>DOB: $dob_day / $dob_month / $dob_year</p>";
                } //$field == "Title"
                
                if ($field == "Ethinicity") {
                    $Body .= "<hr/><h3>Ethinicity details</h3>";
                } //$field == "Ethinicity"
                
                if ($field == "Qualification Level") {
                    $Body .= "<hr/><h3>Qualification entry</h3>";
                } 

                if ($field == "Previous level q 01") {
                    $Body .= "<h4>Previous qualificiation 01</h4>";
                } 
                
                if ($field == "Previous level q 02") {
                    $Body .= "<h4>Previous qualificiation 02</h4>";
                } 
                
                if ($field == "Guidance") {
                    $Body .= "<hr/><h3>Find Out More</h3>";
                } 
                
                if ($field == "W School") {
                    $Body .= "<hr/><h3>Where did you hear about us?</h3>";
                } 
                
                if ($field == "Disability") {
                    $Body .= "<hr/><h3>Do you consider yourself to have a disability, specific learning difficulty or specific health problem?</h3>";
                }
                
                if ($field == "No Disabilities") {
                    $Body .= "<hr/><h3>Health Issues?</h3>";
                } 
